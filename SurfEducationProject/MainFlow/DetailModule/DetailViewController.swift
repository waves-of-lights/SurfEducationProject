...
private extension DetailViewController {
    ...
    func configureTableView() {
        ...
        tableView.registerCell(with: DetailImageTableViewCell.self)
        tableView.registerCell(with: DetailTitleTableViewCell.self)
        tableView.registerCell(with: DetailTextTableViewCell.self)
